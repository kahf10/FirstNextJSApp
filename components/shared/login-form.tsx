          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <AtSign className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-400" />
            </div>
          </div>
          <div className="mt-4">
            <label
            ...
            <div className="relative">
              <input
                ...
                minLength={6}
              />
              <LockKeyhole className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-400" />
            </div>
          </div>
        </div>
        <div className="mt-4">
          <Button aria-disabled={isPending} type="submit">
            Log in <ArrowRightIcon className="ml-auto h-4 w-5" />
          </Button>
        </div>
        <div
